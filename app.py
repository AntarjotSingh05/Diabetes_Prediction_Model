...
df = pd.read_csv(r'C:\Diabetes\diabetes.csv') # If you want to test this code on your laptop or PC just compy the path of the csv file shown on your device when you clone the projecct
